import { BN, Buffer, cryptography } from "../deps.js";
import { bufferToHex, setLengthLeft, toBuffer } from "./bytes.ts";
...
export const isValidSignature = function (
  ...
  if (
    rBN.isZero() || rBN.gt(SECP256K1_N) || sBN.isZero() || sBN.gt(SECP256K1_N)
  ) {
    return false;
  }
